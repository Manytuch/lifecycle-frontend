      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-24 grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl p-10 shadow-md hover:shadow-xl transition duration-300">
            ...
            <p className="mt-4 text-gray-600 leading-relaxed">
              To provide efficient, reliable, and professional logistics,
              customs clearance, warehousing, and supply services that empower
              businesses and contribute to economic growth across South Sudan.
            </p>
          ...
          <div className="bg-white rounded-3xl p-10 shadow-md hover:shadow-xl transition duration-300">
            ...
            <p className="mt-4 text-gray-600 leading-relaxed">
              To become South Sudan’s leading logistics and general trading
              company recognized for excellence, integrity, innovation, and
              customer satisfaction.
            </p>
