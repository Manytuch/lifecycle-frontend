      ...
      >
        ...
        <div
          style={{
            ...
            background:
              "linear-gradient(to top,rgba(11,22,40,.65) 0%,transparent 55%)",
          }}
        />
  ...
  return (
    <>
      <style>{`
        ...
        .group:hover .svc-card-border{
          opacity:1!important;
        }

        .group:hover .featured-img{
