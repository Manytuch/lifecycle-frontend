  ...
  return (
    <>
      <style>{`
        ...
        .contact-info-row:hover { gap: 20px; }
        ...
        .wa-btn {
          ...
          box-shadow: 0 8px 28px rgba(26,122,74,0.35);
        }
        .wa-btn:hover {
          transform: translateY(-2px);
          box-shadow: 0 16px 40px rgba(26,122,74,0.45);
        }
      ...
      >
        {/* blobs */}
        <div aria-hidden style={{ position: "absolute", top: -100, right: -80, width: 500, height: 500, borderRadius: "50%", background: "radial-gradient(circle, rgba(201,168,76,0.06) 0%, transparent 70%)", pointerEvents: "none" }} />
        <div aria-hidden style={{ position: "absolute", bottom: -60, left: -80, width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(11,22,40,0.05) 0%, transparent 70%)", pointerEvents: "none" }} />
        ...
        >
          ...
          <div
            style={{
              ...
              boxShadow: "0 32px 80px rgba(11,22,40,0.1)",
              overflow: "hidden",
            }}
          >
            {/* card header band */}
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  backgroundImage: "repeating-linear-gradient(135deg, #c9a84c 0px, #c9a84c 1px, transparent 1px, transparent 52px)",
                }}
              />
              <p
                style={{
